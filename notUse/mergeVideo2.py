...
from contant.PathContant import normalFragmentPath
...
if __name__ == '__main__':
    sourceFiles = getFloderCombination(normalFragmentPath)
    concat(sourceFiles, "D:/duan/file/shortVideo/AfterProcesse/20220502")